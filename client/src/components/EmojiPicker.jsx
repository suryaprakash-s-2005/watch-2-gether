...
const EmojiPicker = ({ onEmojiSelect, isDarkMode = true }) => {
  return (
    <div className="absolute bottom-full right-0 mb-3 w-[320px] max-w-[calc(100vw-2rem)] h-[320px] z-50 shadow-2xl rounded-2xl overflow-hidden border border-slate-800/80 bg-slate-950/95 backdrop-blur-md animate-fadeIn">
      <EmojiPickerReact
